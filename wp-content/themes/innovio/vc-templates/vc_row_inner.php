...
if ( $row_content_width === 'grid' ) {
	$mkdf_row_wrapper_start .= '<div class="mkdf-row-grid-section-wrapper ' . esc_attr( $grid_row_classes ) . '" ' . innovio_mikado_get_inline_style( $mkdf_grid_row_styles ) . '><div class="mkdf-row-grid-section">';
...
if( $enable_grid_lines === 'grid_line_right' ) {
    ...
    $mkdf_grid_row_parallax_grids = '<span class="mkdf-grid-line-center"><span class="mkdf-grid-line-inner" data-parallax="{&quot;y&quot;:750, &quot;smoothness&quot;:25}"></span></span><span class="mkdf-grid-line-right"><span class="mkdf-grid-line-inner" data-parallax="{&quot;y&quot;:-450, &quot;smoothness&quot;:25}"></span></span>';
}
