			...
			mkdfImportBtn.on('click', function (e) {
				...
				if (confirm(confirmMessage)) {
					...
					if (import_opt === 'content') {
						for (var i = 1; i < 10; i++) {
							var str = i < 10 ? 'innovio_content_0' + i + '.xml' : 'innovio_content_' + i + '.xml';
							
							jQuery.ajax({
								type: 'POST',
								url: ajaxurl,
								data: {
									action: 'innovio_core_data_import',
									xml: str,
									example: import_expl,
						...
						$.ajax({
							...
							url: ajaxurl,
							data: {
								action: 'innovio_core_widgets_import',
								example: import_expl
							},
							success: function (data, textStatus, XMLHttpRequest) {
						...
						jQuery.ajax({
							...
							url: ajaxurl,
							data: {
								action: 'innovio_core_options_import',
								example: import_expl
							},
							success: function (data, textStatus, XMLHttpRequest) {
								$('.progress-value').html((100) + '%');
						...
						for (var i = 1; i < 10; i++) {
							var str = i < 10 ? str = 'innovio_content_0' + i + '.xml' : 'innovio_content_' + i + '.xml';
										...
										jQuery.ajax({
											...
											success: function (data, textStatus, XMLHttpRequest) {
												jQuery.ajax({
													...
													url: ajaxurl,
													data: {
														action: 'innovio_core_other_import',
														example: import_expl
													},
													success: function (data, textStatus, XMLHttpRequest) {
														//alert(data);
