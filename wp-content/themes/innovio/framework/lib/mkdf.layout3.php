...
class InnovioMikadoClassInstagramFramework implements iInnovioMikadoInterfaceRender {
	public function render( $factory ) {
		...
		if ( ! get_option( 'innovio_instagram_code' ) ) {
			...
			if ( ! empty( $_GET['code'] ) ) {
				...
				$message = esc_html__( 'You have successfully connected with your Instagram account. If you have any issues fetching data from Instagram try reconnecting.', 'innovio' );
		...
		$buttonText = $instagram_api->hasUserConnected() ? esc_html__( 'Re-connect with Instagram', 'innovio' ) : esc_html__( 'Connect with Instagram', 'innovio' );
		?>
		<?php if ( $message !== '' ) { ?>
			<div class="alert alert-success">
				<span><?php echo esc_html( $message ); ?></span>
