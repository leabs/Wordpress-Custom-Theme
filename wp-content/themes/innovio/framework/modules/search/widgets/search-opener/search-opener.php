...
if ( class_exists( 'InnovioCoreClassWidget' ) ) {
    class InnovioMikadoClassSearchOpener extends InnovioCoreClassWidget {
        public function __construct() {
            parent::__construct(
                'mkdf_search_opener',
                esc_html__( 'Innovio Search Opener', 'innovio' ),
                array( 'description' => esc_html__( 'Display a "search" icon that opens the search form', 'innovio' ) )
            );
        ...
        protected function setParams() {
            ...
            $search_icon_params = array(
                array(
                    ...
                    'description' => esc_html__( 'Define color for search icon', 'innovio' )
                ),
                array(
                    'type'        => 'colorpicker',
                    'name'        => 'search_icon_hover_color',
                    'title'       => esc_html__( 'Icon Hover Color', 'innovio' ),
                    'description' => esc_html__( 'Define hover color for search icon', 'innovio' )
                ),
                array(
                    'type'        => 'textfield',
                ...
                array(
                    'type'        => 'dropdown',
                    'name'        => 'show_label',
                    'title'       => esc_html__( 'Enable Search Icon Text', 'innovio' ),
            ...
            $search_icon_pack_params = array(
                array(
                    ...
                    'description' => esc_html__( 'Define size for search icon', 'innovio' )
                )
            );

            if ( innovio_mikado_options()->getOptionValue( 'search_icon_pack' ) == 'icon_pack' ) {
        ...
        public function widget( $args, $instance ) {
            $enable_search_icon_text = innovio_mikado_options()->getOptionValue( 'enable_search_icon_text' );
            ...
            $classes[] = innovio_mikado_get_icon_sources_class( 'search', 'mkdf-search-opener' );
            ...
            <a <?php innovio_mikado_inline_attr( $instance['search_icon_hover_color'], 'data-hover-color' ); ?> <?php innovio_mikado_inline_style( $styles ); ?> <?php innovio_mikado_class_attribute( $classes ); ?> href="javascript:void(0)">
            <span class="mkdf-search-opener-wrapper">
	            <?php echo innovio_mikado_get_icon_sources_html( 'search', false, array( 'search' => 'yes' ) ); ?>
                <?php if ( $show_search_text ) { ?>
                    <span class="mkdf-search-icon-text"><?php esc_html_e( 'Search', 'innovio' ); ?></span>
                <?php } ?>
            </span>
            </a>
        <?php }
