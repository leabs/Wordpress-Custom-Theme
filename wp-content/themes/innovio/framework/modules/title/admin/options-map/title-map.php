...
if ( ! function_exists( 'innovio_mikado_get_title_types_options' ) ) {
	function innovio_mikado_get_title_types_options() {
		$title_type_options = apply_filters( 'innovio_mikado_filter_title_type_global_option', $title_type_options = array() );
		
		return $title_type_options;
	}
}

if ( ! function_exists( 'innovio_mikado_get_title_type_default_options' ) ) {
	function innovio_mikado_get_title_type_default_options() {
		$title_type_option = apply_filters( 'innovio_mikado_filter_default_title_type_global_option', $title_type_option = '' );
...
if ( ! function_exists('innovio_mikado_title_options_map') ) {
	function innovio_mikado_title_options_map() {
		$title_type_options        = innovio_mikado_get_title_types_options();
		$title_type_default_option = innovio_mikado_get_title_type_default_options();
		...
		$panel_title = innovio_mikado_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
				'title' => esc_html__('Title Settings', 'innovio')
			)
		);
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'This option will enable/disable Title Area', 'innovio' ),
				'parent'        => $panel_title
			)
		);
		
			$show_title_area_container = innovio_mikado_add_admin_container(
				array(
					'parent'          => $panel_title,
				...
				innovio_mikado_add_admin_field(
					...
					innovio_mikado_add_admin_field(
						array(
							...
							'description'   => esc_html__( 'Specify title vertical alignment', 'innovio' ),
							'parent'        => $show_title_area_container,
							'options'       => array(
		...
		do_action( 'innovio_mikado_action_additional_title_area_options_map', $show_title_area_container );
		
		/***************** Additional Title Area Layout - end *****************/
		
		
		$panel_typography = innovio_mikado_add_admin_panel(
			array(
				'page'  => '_title_page',
			...
			$group_page_title_styles = innovio_mikado_add_admin_group(
				array(
					'name'        => 'group_page_title_styles',
					'title'       => esc_html__( 'Title', 'innovio' ),
					'description' => esc_html__( 'Define styles for page title', 'innovio' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_title_styles_1 = innovio_mikado_add_admin_row(
					array(
				...
				$row_page_title_styles_2 = innovio_mikado_add_admin_row(
					array(
				...
				$row_page_title_styles_3 = innovio_mikado_add_admin_row(
					array(
			...
			innovio_mikado_add_admin_section_title(
				array(
					...
					'title'  => esc_html__( 'Subtitle', 'innovio' ),
					'parent' => $panel_typography
				)
			);
		
			$group_page_subtitle_styles = innovio_mikado_add_admin_group(
				array(
					'name'        => 'group_page_subtitle_styles',
					'title'       => esc_html__( 'Subtitle', 'innovio' ),
					'description' => esc_html__( 'Define styles for page subtitle', 'innovio' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_subtitle_styles_1 = innovio_mikado_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_2 = innovio_mikado_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_3 = innovio_mikado_add_admin_row(
					array(
		...
		do_action( 'innovio_mikado_action_additional_title_typography_options_map', $panel_typography );
		
		/***************** Additional Title Typography Layout - end *****************/
    }

	add_action( 'innovio_mikado_action_options_map', 'innovio_mikado_title_options_map', innovio_mikado_set_options_map_position( 'title' ) );
}