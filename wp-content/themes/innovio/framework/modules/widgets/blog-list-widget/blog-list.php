...
if ( class_exists( 'InnovioCoreClassWidget' ) ) {
    class InnovioMikadoClassBlogListWidget extends InnovioCoreClassWidget {
        public function __construct() {
            parent::__construct(
                'mkdf_blog_list_widget',
                esc_html__( 'Innovio Blog List Widget', 'innovio' ),
                array( 'description' => esc_html__( 'Display a list of your blog posts', 'innovio' ) )
            );
            ...
            $this->params = array(
                ...
                array(
                    ...
                    'options' => array(
                        ...
                        'minimal' => esc_html__( 'Minimal', 'innovio' )
                    )
                ),
                array(
                    'type'  => 'textfield',
                    'name'  => 'number_of_posts',
                    'title' => esc_html__( 'Number of Posts', 'innovio' )
                ),
                array(
                    'type'    => 'dropdown',
                ...
                array(
                    'type'    => 'dropdown',
                    'name'    => 'orderby',
                    'title'   => esc_html__( 'Order By', 'innovio' ),
                    'options' => innovio_mikado_get_query_order_by_array()
                ),
                array(
                    'type'    => 'dropdown',
                    'name'    => 'order',
                    'title'   => esc_html__( 'Order', 'innovio' ),
                    'options' => innovio_mikado_get_query_order_array()
                ),
                array(
                    'type'        => 'textfield',
                    'name'        => 'category',
                    'title'       => esc_html__( 'Category Slug', 'innovio' ),
                    'description' => esc_html__( 'Leave empty for all or use comma for list', 'innovio' )
                ),
                array(
                    'type'    => 'dropdown',
                    'name'    => 'title_tag',
                ...
                array(
                    ...
                    'title'   => esc_html__( 'Title Text Transform', 'innovio' ),
        ...
        public function widget( $args, $instance ) {
            ...
            echo '<div class="widget mkdf-blog-list-widget" ' . innovio_mikado_get_inline_style( $widget_styles ) . '>';
