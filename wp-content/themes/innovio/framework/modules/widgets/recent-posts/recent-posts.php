...
if ( class_exists( 'InnovioCoreClassWidget' ) ) {
    class InnovioMikadoClassRecentPosts extends InnovioCoreClassWidget {
        public function __construct() {
            parent::__construct(
                'mkdf_recent_posts',
                esc_html__( 'Innovio Recent Posts', 'innovio' ),
                array( 'description' => esc_html__( 'Select recent posts that you would like to display', 'innovio' ) )
            );
        ...
        protected function setParams() {
            $post_types = apply_filters( 'innovio_mikado_filter_search_post_type_widget_params_post_type', array( 'post' => esc_html__( 'Post', 'innovio' ) ) );
            ...
            $this->params = array(
                ...
                array(
                    'type'        => 'dropdown',
                    'name'        => 'post_type',
                    'title'       => esc_html__( 'Post Type', 'innovio' ),
                    'description' => esc_html__( 'Choose post type that you want to be searched for', 'innovio' ),
                    'options'     => $post_types
                ),
                array(
                    'type'        => 'dropdown',
        ...
        public function widget( $args, $instance ) {
            ...
            $html = '<div class="widget mkdf-recent-post-widget" ' . innovio_mikado_get_inline_style( $widget_styles ) . '>';
            ...
            if ( $query->have_posts() ) {
                ...
                $html .= esc_html__('Sorry, there are no posts matching your criteria', 'innovio');
            }
            ...
            echo innovio_mikado_get_module_part( $html );
        }
    }
}