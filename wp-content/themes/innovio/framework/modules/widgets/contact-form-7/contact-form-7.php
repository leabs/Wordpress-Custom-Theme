...
if ( class_exists( 'InnovioCoreClassWidget' ) ) {
    class InnovioMikadoClassContactForm7Widget extends InnovioCoreClassWidget {
        public function __construct() {
            parent::__construct(
                'mkdf_contact_form_7_widget',
                esc_html__( 'Innovio Contact Form 7 Widget', 'innovio' ),
                array( 'description' => esc_html__( 'Add contact form 7 to widget areas', 'innovio' ) )
            );
        ...
        protected function setParams() {
            ...
            $this->params = array(
                array(
                    'type'  => 'textfield',
                    'name'  => 'extra_class',
                    'title' => esc_html__( 'Extra Class Name', 'innovio' )
                ),
                array(
                    'type'  => 'textfield',
                ...
                array(
                    'type'    => 'dropdown',
                    'name'    => 'contact_form',
                    'title'   => esc_html__( 'Select Contact Form 7', 'innovio' ),
                    'options' => $contact_forms
                ),
                array(
                    'type'    => 'dropdown',
                    'name'    => 'contact_form_style',
                    'title'   => esc_html__( 'Contact Form 7 Style', 'innovio' ),
                    'options' => array(
        ...
        public function widget( $args, $instance ) {
            ...
            ?>
            <div class="widget mkdf-contact-form-7-widget <?php echo esc_attr( $extra_class ); ?>" <?php echo innovio_mikado_get_inline_style( $widget_styles ); ?>>
