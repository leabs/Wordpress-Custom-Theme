...
if ( class_exists( 'InnovioCoreClassWidget' ) ) {
    class InnovioMikadoClassSocialIconWidget extends InnovioCoreClassWidget {

        public function __construct() {
            parent::__construct(
                'mkdf_social_icon_widget',
                esc_html__( 'Innovio Social Icon Widget', 'innovio' ),
                array( 'description' => esc_html__( 'Add social network icons to widget areas', 'innovio' ) )
            );
            ...
            $this->params = array_merge(
                array(
                    array(
                        'type'  	  => 'dropdown',
                        'name'  	  => 'icon_text',
                        'title' 	  => esc_html__( 'Display Icon or Text', 'innovio' ),
                        'description' => esc_html__( 'Choose whether you want to display social icon or text instead', 'innovio' ),
                        'options' 	  => array(
                            'icon' => esc_html__( 'Icon', 'innovio' ),
                            'text' => esc_html__( 'Text', 'innovio' )
                        )
                    ),
                    array(
                        'type'        => 'textfield',
                        'name'        => 'social_text',
                        'title'       => esc_html__( 'Social Text', 'innovio' ),
                        'description' => esc_html__( 'Instert text which will describe desired social network', 'innovio' )
                    )
                ),
                innovio_mikado_icon_collections()->getSocialIconWidgetParamsArray(),
                array(
                    array(
                        'type'  => 'textfield',
                        'name'  => 'link',
        ...
        public function widget( $args, $instance ) {
            ...
            ?>
            <a class="mkdf-social-icon-widget-holder mkdf-icon-has-hover" <?php echo innovio_mikado_get_inline_attr( $hover_color, 'data-hover-color' ); ?> <?php innovio_mikado_inline_style( $icon_styles ) ?> href="<?php echo esc_url( $link ); ?>" target="<?php echo esc_attr( $target ); ?>">
