...
if ( ! function_exists( 'innovio_mikado_get_hide_dep_for_header_vertical_menu_options' ) ) {
	function innovio_mikado_get_hide_dep_for_header_vertical_menu_options() {
		$hide_dep_options = apply_filters( 'innovio_mikado_filter_header_vertical_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'innovio_mikado_header_vertical_navigation_options_map' ) ) {
	function innovio_mikado_header_vertical_navigation_options_map() {
		$hide_dep_options = innovio_mikado_get_hide_dep_for_header_vertical_menu_options();
		
		$panel_vertical_main_menu = innovio_mikado_add_admin_panel(
			array(
				'title'           => esc_html__( 'Vertical Main Menu', 'innovio' ),
		...
		$drop_down_group = innovio_mikado_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Set a style for dropdown menu', 'innovio' )
			)
		);
		
		$vertical_drop_down_row1 = innovio_mikado_add_admin_row(
			array(
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Top Margin', 'innovio' ),
				'args'          => array(
					'suffix' => 'px'
				),
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Bottom Margin', 'innovio' ),
				'args'          => array(
					'suffix' => 'px'
				),
				'parent'        => $vertical_drop_down_row1
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => 'below',
				'label'         => esc_html__( 'Submenu Opening', 'innovio' ),
				'options'		=> array(
					'below' => esc_html__('Below', 'innovio'),
					'side' => esc_html__('On Side', 'innovio'),
				),
				'parent'        => $panel_vertical_main_menu
			)
		);

		$group_vertical_first_level = innovio_mikado_add_admin_group(
			array(
				'name'        => 'group_vertical_first_level',
				'title'       => esc_html__( '1st level', 'innovio' ),
				'description' => esc_html__( 'Define styles for 1st level menu', 'innovio' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_first_level_1 = innovio_mikado_add_admin_row(
			array(
		...
		$row_vertical_first_level_2 = innovio_mikado_add_admin_row(
			array(
		...
		$row_vertical_first_level_3 = innovio_mikado_add_admin_row(
			array(
		...
		$group_vertical_second_level = innovio_mikado_add_admin_group(
			array(
				'name'        => 'group_vertical_second_level',
				'title'       => esc_html__( '2nd level', 'innovio' ),
				'description' => esc_html__( 'Define styles for 2nd level menu', 'innovio' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_second_level_1 = innovio_mikado_add_admin_row(
			array(
		...
		$row_vertical_second_level_2 = innovio_mikado_add_admin_row(
			array(
		...
		$row_vertical_second_level_3 = innovio_mikado_add_admin_row(
			array(
		...
		$group_vertical_third_level = innovio_mikado_add_admin_group(
			array(
				'name'        => 'group_vertical_third_level',
				'title'       => esc_html__( '3rd level', 'innovio' ),
				'description' => esc_html__( 'Define styles for 3rd level menu', 'innovio' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_third_level_1 = innovio_mikado_add_admin_row(
			array(
		...
		$row_vertical_third_level_2 = innovio_mikado_add_admin_row(
			array(
		...
		$row_vertical_third_level_3 = innovio_mikado_add_admin_row(
			array(
	...
	add_action( 'innovio_mikado_action_additional_header_main_navigation_options_map', 'innovio_mikado_header_vertical_navigation_options_map', 10, 1 );
}