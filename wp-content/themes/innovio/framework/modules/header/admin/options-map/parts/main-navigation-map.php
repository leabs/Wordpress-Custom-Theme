...
if ( ! function_exists( 'innovio_mikado_get_hide_dep_for_header_main_menu_options' ) ) {
	function innovio_mikado_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'innovio_mikado_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'innovio_mikado_header_main_navigation_options_map' ) ) {
	function innovio_mikado_header_main_navigation_options_map() {
		$hide_dep_options = innovio_mikado_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = innovio_mikado_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'innovio' ),
		...
		innovio_mikado_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'innovio' )
			)
		);
		
		$drop_down_group = innovio_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'innovio' ),
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'innovio' )
			)
		);
		
		$drop_down_row1 = innovio_mikado_add_admin_row(
			array(
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'innovio' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'innovio' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'innovio' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'innovio' )
				)
			)
		);
		...
		$first_level_group = innovio_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'first_level_group',
				'title'       => esc_html__( '1st Level Menu', 'innovio' ),
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'innovio' )
			)
		);
		
		$first_level_row1 = innovio_mikado_add_admin_row(
			array(
		...
		$first_level_row3 = innovio_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'innovio' ),
			)
		);
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'innovio' ),
			)
		);
		
		$first_level_row4 = innovio_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'innovio' ),
			)
		);
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'innovio' ),
			)
		);
		
		$first_level_row5 = innovio_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = innovio_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = innovio_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'innovio' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'innovio' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = innovio_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_group',
				'title'       => esc_html__( '2nd Level Menu', 'innovio' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'innovio' )
			)
		);
		
		$second_level_row1 = innovio_mikado_add_admin_row(
			array(
		...
		innovio_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'innovio' )
			)
		);
		
		$second_level_row2 = innovio_mikado_add_admin_row(
			array(
				'parent' => $second_level_group,
		...
		$second_level_row3 = innovio_mikado_add_admin_row(
			array(
				'parent' => $second_level_group,
		...
		$second_level_wide_group = innovio_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'innovio' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'innovio' )
			)
		);
		
		$second_level_wide_row1 = innovio_mikado_add_admin_row(
			array(
		...
		$second_level_wide_row2 = innovio_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = innovio_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = innovio_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_group',
				'title'       => esc_html__( '3nd Level Menu', 'innovio' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'innovio' )
			)
		);
		
		$third_level_row1 = innovio_mikado_add_admin_row(
			array(
		...
		$third_level_row2 = innovio_mikado_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_row3 = innovio_mikado_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = innovio_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'innovio' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'innovio' )
			)
		);
		
		$third_level_wide_row1 = innovio_mikado_add_admin_row(
			array(
		...
		$third_level_wide_row2 = innovio_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = innovio_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'innovio_mikado_action_header_main_navigation_options_map', 'innovio_mikado_header_main_navigation_options_map', 10, 1 );
}