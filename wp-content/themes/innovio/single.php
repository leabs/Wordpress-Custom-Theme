...
if ( have_posts() ) : while ( have_posts() ) : the_post();
	...
	innovio_mikado_include_blog_helper_functions( 'singles', 'standard' );
	
	//Action added for applying module specific filters that couldn't be applied on init
	do_action( 'innovio_mikado_action_blog_single_loaded' );
	...
	<div class="<?php echo esc_attr( $mkdf_holder_params['holder'] ); ?>">
		...
		<div class="<?php echo esc_attr( $mkdf_holder_params['inner'] ); ?>">
			<?php innovio_mikado_get_blog_single( 'standard' ); ?>
		</div>
