        ...
        <div class="columns">
            <div class="column is-3 is-hidden-touch"
                ...
                <aside class="menu blog-menu">
                    ...
                    <ul class="menu-list events-list">
                        <li><a
                                href="<?php echo wp_make_link_relative('https://atmosphereiot.com/category/gallery/avr-iot-project/'); ?>">AVR IoT</a></li>
                        <li><a
                                href="<?php echo wp_make_link_relative('https://atmosphereiot.com/category/gallery/nxp-rapid-iot-projects/'); ?>">NXP Rapid IoT</a></li>
