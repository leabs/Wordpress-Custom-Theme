                ...
                <div class="column is-3 is-hidden-touch" style="padding-left:12px; padding-right:22px; padding-top:20px; padding-bottom:0; padding-top:0;">
                    ...
                    <aside class="menu blog-menu">
                        ...
                        <ul class="menu-list blog-list">
                            ...
                            <li><a href="<?php echo wp_make_link_relative('http://localhost/Wordpress-Custom-Theme/category/blog/platform'); ?>"">Platform</a></li>
                        </ul>
                        ...
                        <ul class="menu-list events-list">
                            <li><a href="<?php echo wp_make_link_relative('http://localhost/Wordpress-Custom-Theme/events/'); ?>">Upcoming Events</a></li>
                            <li><a href="<?php echo wp_make_link_relative('http://localhost/Wordpress-Custom-Theme/events-archive/'); ?>">Event Archive</a></li>
                        </ul>
                        <p class="menu-label">
                            News
                        </p>
