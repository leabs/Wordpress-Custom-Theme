...
namespace InnovioCore\CPT\Shortcodes\Portfolio;
...
class PortfolioList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Portfolio List', 'innovio-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Portfolio List Template', 'innovio-core' ),
							'value'       => array(
								esc_html__( 'Gallery', 'innovio-core' ) => 'gallery',
								esc_html__( 'Masonry', 'innovio-core' ) => 'masonry'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Click Behavior', 'innovio-core' ),
							'value'      => array(
								esc_html__( 'Open portfolio single page on click', 'innovio-core' )   => '',
								esc_html__( 'Open gallery in Pretty Photo on click', 'innovio-core' ) => 'gallery'
							)
						),
						array(
							'type'        => 'dropdown',
							...
							'value'       => array_flip( innovio_mikado_get_number_of_columns_array( true ) ),
							'description' => esc_html__( 'Default value is Three', 'innovio-core' ),
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Per Page', 'innovio-core' ),
							'description' => esc_html__( 'Set number of items for your portfolio list. Enter -1 to show all.', 'innovio-core' ),
							'value'       => '-1'
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'image_proportions',
							'heading'     => esc_html__( 'Image Proportions', 'innovio-core' ),
							'value'       => array(
								esc_html__( 'Original', 'innovio-core' )  => 'full',
								esc_html__( 'Square', 'innovio-core' )    => 'square',
								esc_html__( 'Landscape', 'innovio-core' ) => 'landscape',
								esc_html__( 'Portrait', 'innovio-core' )  => 'portrait',
								esc_html__( 'Medium', 'innovio-core' )    => 'medium',
								esc_html__( 'Large', 'innovio-core' )     => 'large'
							),
							'description' => esc_html__( 'Set image proportions for your portfolio list.', 'innovio-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'gallery' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'enable_fixed_proportions',
							'heading'     => esc_html__( 'Enable Fixed Image Proportions', 'innovio-core' ),
							'value'       => array_flip( innovio_mikado_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Set predefined image proportions for your masonry portfolio list. This option will apply image proportions you set in Portfolio Single page - dimensions for masonry option.', 'innovio-core' ),
                        ...
                        array(
                            'type'        => 'dropdown',
                            'param_name'  => 'enable_image_rounded_corners',
						...
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'category',
							'heading'     => esc_html__( 'One-Category Portfolio List', 'innovio-core' ),
							'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'innovio-core' )
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'selected_projects',
							'heading'     => esc_html__( 'Show Only Projects with Listed IDs', 'innovio-core' ),
							'settings'    => array(
								'multiple'      => true,
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'Delimit ID numbers by comma (leave empty for all)', 'innovio-core' )
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'tag',
							'heading'     => esc_html__( 'One-Tag Portfolio List', 'innovio-core' ),
							'description' => esc_html__( 'Enter one tag slug (leave empty for showing all tags)', 'innovio-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'orderby',
							'heading'     => esc_html__( 'Order By', 'innovio-core' ),
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'order',
							'heading'     => esc_html__( 'Order', 'innovio-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Item Style', 'innovio-core' ),
							'value'      => array(
								esc_html__( 'Standard - Shader', 'innovio-core' )                 => 'standard-shader',
								esc_html__( 'Standard - Switch Featured Images', 'innovio-core' ) => 'standard-switch-images',
								esc_html__( 'Gallery - Overlay', 'innovio-core' )                 => 'gallery-overlay',
								esc_html__( 'Gallery - Overlay Center', 'innovio-core' )            => 'gallery-center-overlay',
							),
							'group'       => esc_html__( 'Content Layout', 'innovio-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'content_top_margin',
							'heading'    => esc_html__( 'Content Top Margin (px or %)', 'innovio-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Bottom Margin (px or %)', 'innovio-core' ),
							'dependency' => array( 'element' => 'item_style', 'value' => array( 'standard-shader', 'standard-switch-images' ) ),
							'group'      => esc_html__( 'Content Layout', 'innovio-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Title', 'innovio-core' ),
							'value'      => array_flip( innovio_mikado_get_yes_no_select_array( false, true ) ),
							'group'      => esc_html__( 'Content Layout', 'innovio-core' )
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Title Text Transform', 'innovio-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Enable Category', 'innovio-core' ),
							'value'      => array_flip( innovio_mikado_get_yes_no_select_array( false, true ) ),
							'group'      => esc_html__( 'Content Layout', 'innovio-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Number of Images', 'innovio-core' ),
							'value'      => array_flip( innovio_mikado_get_yes_no_select_array( false, true ) ),
							'dependency' => array( 'element' => 'type', 'value' => array( 'gallery' ) ),
							'group'      => esc_html__( 'Content Layout', 'innovio-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Excerpt', 'innovio-core' ),
							'value'      => array_flip( innovio_mikado_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Content Layout', 'innovio-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Excerpt Length', 'innovio-core' ),
							'description' => esc_html__( 'Number of characters', 'innovio-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Type', 'innovio-core' ),
							'value'      => array(
								esc_html__( 'None', 'innovio-core' )            => 'no-pagination',
								esc_html__( 'Standard', 'innovio-core' )        => 'standard',
								esc_html__( 'Load More', 'innovio-core' )       => 'load-more',
								esc_html__( 'Infinite Scroll', 'innovio-core' ) => 'infinite-scroll'
							),
							'group'      => esc_html__( 'Additional Features', 'innovio-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'load_more_top_margin',
							'heading'    => esc_html__( 'Load More Top Margin (px or %)', 'innovio-core' ),
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'filter',
							'heading'    => esc_html__( 'Enable Category Filter', 'innovio-core' ),
							'value'      => array_flip( innovio_mikado_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Additional Features', 'innovio-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Order By', 'innovio-core' ),
							'value'      => array(
								esc_html__( 'Name', 'innovio-core' )  => 'name',
								esc_html__( 'Count', 'innovio-core' ) => 'count',
								esc_html__( 'Id', 'innovio-core' )    => 'id',
								esc_html__( 'Slug', 'innovio-core' )  => 'slug'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Filter Text Transform', 'innovio-core' ),
							'value'      => array_flip( innovio_mikado_get_text_transform_array( true ) ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'innovio-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Bottom Margin (px or %)', 'innovio-core' ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'innovio-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Enable Article Animation', 'innovio-core' ),
							'value'       => array_flip( innovio_mikado_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Enabling this option you will enable appears animation for your portfolio list items', 'innovio-core' ),
							'group'       => esc_html__( 'Additional Features', 'innovio-core' )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		$args   = array(
			...
			'enable_image_rounded_corners' => 'yes',
			'category'                 => '',
			'selected_projects'        => '',
			'tag'                      => '',
			'orderby'                  => 'date',
		...
		$additional_params['holder_data']          = innovio_mikado_get_holder_data_for_cpt( $params, $additional_params );
		...
		$html = innovio_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-list', 'portfolio-holder', $params['type'], $params, $additional_params );
	...
	public function getHolderClasses( $params, $args ) {
		...
		$classes[] = $params['enable_image_rounded_corners'] === 'yes' ? 'mkdf-pl-has-rounded-corners' : '';
	...
	public function getArticleClasses( $params ) {
		...
		if (get_post_meta( get_the_ID(), "mkdf_portfolio_single_skin_meta", true ) === "yes") {
			$classes[] = 'mkdf-pl-light-skin';
		}
	...
	public function getImageSize( $params ) {
		...
		if ( ! empty( $params['image_proportions'] ) && $params['type'] == 'gallery' ) {
			...
			switch ( $image_size ) {
				case 'landscape':
					$thumb_size = 'innovio_mikado_image_landscape';
					break;
				case 'portrait':
					$thumb_size = 'innovio_mikado_image_portrait';
					break;
				case 'square':
					$thumb_size = 'innovio_mikado_image_square';
					break;
				case 'medium':
					$thumb_size = 'medium';
					break;
		...
		if ( $params['type'] == 'masonry' && $params['enable_fixed_proportions'] === 'yes' ) {
			...
			switch ( $fixed_image_size ) {
				...
				case 'large-width-height':
					$thumb_size = 'innovio_mikado_image_huge';
					break;
				default :
					$thumb_size = 'full';
					break;
	...
	public function getStandardContentStyles( $params ) {
		...
		if ( ! empty( $margin_top ) ) {
			if ( innovio_mikado_string_ends_with( $margin_top, '%' ) || innovio_mikado_string_ends_with( $margin_top, 'px' ) ) {
		...
		if ( ! empty( $margin_bottom ) ) {
			if ( innovio_mikado_string_ends_with( $margin_bottom, '%' ) || innovio_mikado_string_ends_with( $margin_bottom, 'px' ) ) {
    ...
    public function getCustomOverlayStyles($params) {
        $styles = array();
        $custom_hover_color = get_post_meta(get_the_ID(), 'mkdf_portfolio_hover_background_color_meta', true);
        $custom_hover_transparency = get_post_meta(get_the_ID(), 'mkdf_portfolio_hover_transparency_meta', true);

        if ( $custom_hover_color !== '' ) {
            $custom_hover_overlay_color  = $custom_hover_color;
            $custom_hover_color_transparency = 1;

            if ( $custom_hover_transparency !== '' ) {
                $custom_hover_color_transparency = $custom_hover_transparency;
            }

            $custom_hover_color = innovio_mikado_rgba_color( $custom_hover_overlay_color, $custom_hover_color_transparency );
        }

        if ( ! empty( $custom_hover_color ) ) {
            $styles[] = 'background-color: ' . $custom_hover_color;
        }
	...
	public function getLoadMoreStyles( $params ) {
		...
		if ( ! empty( $params['load_more_top_margin'] ) ) {
			...
			if ( innovio_mikado_string_ends_with( $margin, '%' ) || innovio_mikado_string_ends_with( $margin, 'px' ) ) {
				$styles[] = 'margin-top: ' . $margin;
			} else {
				$styles[] = 'margin-top: ' . innovio_mikado_filter_px( $margin ) . 'px';
			}
		}
	...
	public function getFilterHolderStyles( $params ) {
		...
		if ( ! empty( $params['filter_bottom_margin'] ) ) {
			...
			if ( innovio_mikado_string_ends_with( $margin, '%' ) || innovio_mikado_string_ends_with( $margin, 'px' ) ) {
				...
				$styles[] = 'margin-bottom: ' . innovio_mikado_filter_px( $margin ) . 'px';
			}
		}
	...
	public function getItemLink() {
		...
		return apply_filters( 'innovio_mikado_filter_portfolio_external_link', $portfolio_link );
	}
	...
	public function getItemLinkTarget() {
		...
		return apply_filters( 'innovio_mikado_filter_portfolio_external_link_target', $portfolio_link_target );
	}
	...
	public function portfolioCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['portfolio_category_title'] ) > 0 ) ? esc_html__( 'Category', 'innovio-core' ) . ': ' . $value['portfolio_category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $portfolio_category ) ) {
				...
				if ( ! empty( $portfolio_category_title ) ) {
					$portfolio_category_title_display = esc_html__( 'Category', 'innovio-core' ) . ': ' . $portfolio_category_title;
				}
	...
	public function portfolioIdAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data          = array();
				$data['value'] = $value['id'];
				$data['label'] = esc_html__( 'Id', 'innovio-core' ) . ': ' . $value['id'] . ( ( strlen( $value['title'] ) > 0 ) ? ' - ' . esc_html__( 'Title', 'innovio-core' ) . ': ' . $value['title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( ! is_wp_error( $portfolio ) ) {
				...
				if ( ! empty( $portfolio_title ) ) {
					$portfolio_title_display = ' - ' . esc_html__( 'Title', 'innovio-core' ) . ': ' . $portfolio_title;
				}
				
				$portfolio_id_display = esc_html__( 'Id', 'innovio-core' ) . ': ' . $portfolio_id;
	...
	public function portfolioTagAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data          = array();
				$data['value'] = $value['slug'];
				$data['label'] = ( ( strlen( $value['portfolio_tag_title'] ) > 0 ) ? esc_html__( 'Tag', 'innovio-core' ) . ': ' . $value['portfolio_tag_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $portfolio_tag ) ) {
				...
				if ( ! empty( $portfolio_tag_title ) ) {
					$portfolio_tag_title_display = esc_html__( 'Tag', 'innovio-core' ) . ': ' . $portfolio_tag_title;
				}
