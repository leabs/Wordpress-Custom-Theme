...
class PortfolioSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Slider', 'innovio-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Items', 'innovio-core' ),
							'admin_label' => true,
							'description' => esc_html__( 'Set number of items for your portfolio slider. Enter -1 to show all', 'innovio-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Number of portfolios that are showing at the same time in slider (on smaller screens is responsive so there will be less items shown). Default value is Four', 'innovio-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Set image proportions for your portfolio slider.', 'innovio-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'autocomplete',
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Gallery - Slide From Image Bottom', 'innovio-core' ) => 'gallery-slide-from-image-bottom'
							),
							'save_always' => true,
						...
						array(
							...
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'innovio-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Navigation Skin', 'innovio-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Skin', 'innovio-core' ),
							'value'      => array(
								esc_html__( 'Default', 'innovio-core' ) => '',
								esc_html__( 'Light', 'innovio-core' )   => 'light',
								esc_html__( 'Dark', 'innovio-core' )    => 'dark'
						...
						array(
							...
							'heading'     => esc_html__( 'Pagination Position', 'innovio-core' ),
							'value'       => array(
								esc_html__( 'Below Slider', 'innovio-core' ) => 'below-slider',
								esc_html__( 'On Slider', 'innovio-core' )    => 'on-slider'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'enable_pagination', 'value' => array( 'yes' ) ),
							'group'       => esc_html__( 'Slider Settings', 'innovio-core' )
