<?php
namespace InnovioCore\CPT\Shortcodes\ProgressBarVertical;

use InnovioCore\Lib;

class ProgressBarVertical implements Lib\ShortcodeInterface {
	private $base;
	
	function __construct() {
		$this->base = 'mkdf_progress_bar_vertical';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Progress Bar Vertical', 'innovio-core' ),
					'base'                      => $this->base,
					'icon'                      => 'icon-wpb-progress-bar-vertical extended-custom-icon',
					...
					'params'                    => array(
                        ...
                        array(
                            ...
                            'heading'    => esc_html__( 'Percent Color', 'innovio-core' ),
                        ),
						array(
							'type'       => 'colorpicker',
	...
	public function render( $atts, $content = null ) {
		...
		$html = innovio_core_get_shortcode_module_template_part( 'templates/progress-bar-vertical-template', 'progress-bar-vertical', '', $params );
