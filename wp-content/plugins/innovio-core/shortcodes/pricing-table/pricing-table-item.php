...
class PricingTableItem implements Lib\ShortcodeInterface
{
    ...
    public function vcMap() {
        if (function_exists('vc_map')) {
            vc_map(
                array(
                    'name'                      => esc_html__('Pricing Table Item', 'innovio-core'),
                    'base'                      => $this->base,
                    ...
                    'params'                    => array(
                        ...
                        array(
                            ...
                            'heading'     => esc_html__('Additional Title', 'innovio-core'),
                            'save_always' => true
                        ),
                        array(
                            'type'       => 'colorpicker',
                            'param_name' => 'additional_title_color',
                            'heading'    => esc_html__('Additional Title Color', 'innovio-core'),
                            'dependency' => array('element' => 'additional_title', 'not_empty' => true)
                        ),
                        array(
                            'type'        => 'dropdown',
                            'param_name'  => 'separator',
                            'heading'     => esc_html__( 'Enable Separator under additional title', 'innovio-core' ),
                        ...
                        array(
                            ...
                            'heading'    => esc_html__('Price Color', 'innovio-core'),
                        ...
                        array(
                            ...
                            'heading'    => esc_html__('Currency Color', 'innovio-core'),
                        ...
                        array(
                            ...
                            'heading'    => esc_html__('Price Period Color', 'innovio-core'),
    ...
    public function render($atts, $content = null) {
        ...
        $html = innovio_core_get_shortcode_module_template_part('templates/pricing-table-template', 'pricing-table', '', $params);
