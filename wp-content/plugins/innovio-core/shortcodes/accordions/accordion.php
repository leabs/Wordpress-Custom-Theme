<?php
namespace InnovioCore\CPT\Shortcodes\Accordion;
...
class Accordion implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Accordion', 'innovio-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Accordion', 'innovio-core' ) => 'accordion',
								esc_html__( 'Toggle', 'innovio-core' )    => 'toggle'
							)
						),
						array(
							'type'       => 'dropdown',
	...
	public function render( $atts, $content = null ) {
		...
		$output = innovio_core_get_shortcode_module_template_part( 'templates/accordion-holder-template', 'accordions', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holder_classes[] = ! empty( $params['skin'] ) ? 'mkdf-' . esc_attr( $params['skin'] ) . '-skin' : '';
