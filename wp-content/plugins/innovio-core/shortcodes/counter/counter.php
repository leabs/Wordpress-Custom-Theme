<?php
namespace InnovioCore\CPT\Shortcodes\Counter;
...
class Counter implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Counter', 'innovio-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'value'       => array(
								esc_html__( 'Zero Counter', 'innovio-core' )   => 'mkdf-zero-counter',
								esc_html__( 'Random Counter', 'innovio-core' ) => 'mkdf-random-counter'
							),
							'save_always' => true,
						),
                        array(
                            ...
                            'heading'     => esc_html__( 'Display counters elements in boxes', 'theaisle-core' ),
                            'value'      => array(
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'digit',
							'heading'    => esc_html__( 'Digit', 'innovio-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Digit Color', 'innovio-core' ),
							'dependency' => array( 'element' => 'digit', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'     => esc_html__( 'Title Font Weight', 'innovio-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = innovio_core_get_shortcode_module_template_part( 'templates/counter', 'counter', '', $params );
	...
	private function getHolderClasses( $params ) {
        ...
        $holderClasses[] = ! empty( $params['boxes_with_shadow'] ) ? 'mkdf-counter-'.$params['boxes_with_shadow'] : '';
	...
	private function getCounterStyles( $params ) {
		...
		if ( ! empty( $params['digit_font_size'] ) ) {
			$styles[] = 'font-size: ' . innovio_mikado_filter_px( $params['digit_font_size'] ) . 'px';
		}
