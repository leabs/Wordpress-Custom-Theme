<?php
namespace InnovioCore\CPT\Shortcodes\FullScreenSections;
...
class FullScreenSectionsItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Full Screen Sections Item', 'innovio-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Position', 'innovio-core' ),
							'description' => esc_html__( 'Please insert position in format horizontal vertical position, example - center center', 'innovio-core' ),
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'background_size',
							'heading'     => esc_html__( 'Background Image Size', 'innovio-core' ),
							'value'       => array(
								esc_html__( 'Cover', 'innovio-core' )   => 'cover',
								esc_html__( 'Contain', 'innovio-core' ) => 'contain',
								esc_html__( 'Inherit', 'innovio-core' ) => 'inherit'
							),
							'save_always' => true,
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'padding',
							'heading'     => esc_html__( 'Content Padding', 'innovio-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. You can use px or %', 'innovio-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'vertical_alignment',
							'heading'     => esc_html__( 'Content Vertical Alignment', 'innovio-core' ),
							'value'       => array(
								esc_html__( 'Default', 'innovio-core' ) => '',
								esc_html__( 'Top', 'innovio-core' )     => 'top',
								esc_html__( 'Middle', 'innovio-core' )  => 'middle',
								esc_html__( 'Bottom', 'innovio-core' )  => 'bottom'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Content Horizontal Alignment', 'innovio-core' ),
							'value'       => array(
								esc_html__( 'Default', 'innovio-core' ) => '',
						...
						array(
							...
							'description' => esc_html__( 'Set custom link around item', 'innovio-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Header and Navigation Skin', 'innovio-core' ),
							'value'       => array(
								esc_html__( 'Default', 'innovio-core' ) => '',
							...
							'save_always' => true,
							'description' => esc_html__( 'Choose a predefined header style for header elements and for full screen sections navigation/pagination', 'innovio-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_laptop',
							'heading'     => esc_html__('Background Image for Laptops', 'innovio-core'),
							'group'       => esc_html__('Responsiveness', 'innovio-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet',
							'heading'     => esc_html__('Background Image for Tablets - Landscape', 'innovio-core'),
							'group'       => esc_html__('Responsiveness', 'innovio-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet_portrait',
							'heading'     => esc_html__('Background Image for Tablets - Portrait', 'innovio-core'),
							'group'       => esc_html__('Responsiveness', 'innovio-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_mobile',
							'heading'     => esc_html__('Background Image for Mobiles', 'innovio-core'),
							'group'       => esc_html__('Responsiveness', 'innovio-core')
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = innovio_core_get_shortcode_module_template_part( 'templates/full-screen-sections-item', 'full-screen-sections', '', $params );
