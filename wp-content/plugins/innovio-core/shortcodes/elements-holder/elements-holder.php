...
class ElementsHolder implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Elements Holder', 'innovio-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Holder Full Height', 'innovio-core' ),
						...
						array(
							...
							'value'       => array(
								esc_html__( '1 Column', 'innovio-core' )  => 'one-column',
								esc_html__( '2 Columns', 'innovio-core' ) => 'two-columns',
								esc_html__( '3 Columns', 'innovio-core' ) => 'three-columns',
								esc_html__( '4 Columns', 'innovio-core' ) => 'four-columns',
								esc_html__( '5 Columns', 'innovio-core' ) => 'five-columns',
								esc_html__( '6 Columns', 'innovio-core' ) => 'six-columns'
							),
							'save_always' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Items Float Left', 'innovio-core' ),
							'value'      => array( 'Make Items Float Left?' => 'yes' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'switch_to_one_column',
							'heading'     => esc_html__( 'Switch to One Column', 'innovio-core' ),
							'value'       => array(
								...
								esc_html__( 'Never', 'innovio-core' )        => 'never'
							),
							'description' => esc_html__( 'Choose on which stage item will be in one column', 'innovio-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'alignment_one_column',
							'heading'     => esc_html__( 'Choose Alignment In Responsive Mode', 'innovio-core' ),
							'value'       => array(
								esc_html__( 'Default', 'innovio-core' ) => '',
							...
							'description' => esc_html__( 'Alignment When Items are in One Column', 'innovio-core' ),
							'save_always' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div ' . innovio_mikado_get_class_attribute( $holder_classes ) . ' ' . innovio_mikado_get_inline_attr( $holder_styles, 'style' ) . '>';
