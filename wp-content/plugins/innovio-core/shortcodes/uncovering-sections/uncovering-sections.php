...
class UncoveringSections implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Uncovering Sections', 'innovio-core' ),
					'base'      => $this->base,
	...
	public function render( $atts, $content = null ) {
		...
		$html = innovio_core_get_shortcode_module_template_part( 'templates/uncovering-sections', 'uncovering-sections', '', $params );
