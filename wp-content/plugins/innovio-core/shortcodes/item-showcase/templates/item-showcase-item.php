	...
	<div class="mkdf-item-inner">
        <?php if ( $item_position == 'right') { ?>
            <div class="mkdf-is-icon">
				...
				<?php else: ?>
					<?php echo innovio_mikado_execute_shortcode('mkdf_icon', $icon_params); ?>
				<?php endif; ?>
            </div>
        <?php } ?>
        <div class="mkdf-is-content">
		<?php if (!empty($item_title)) { ?>
			<<?php echo esc_attr($item_title_tag); ?> class="mkdf-is-title" <?php echo innovio_mikado_get_inline_style($item_title_styles); ?>>
		...
		<?php if (!empty($item_text)) { ?>
			<p class="mkdf-is-text" <?php echo innovio_mikado_get_inline_style($item_text_styles); ?>><?php echo esc_html($item_text); ?></p>
		<?php } ?>
        </div>
