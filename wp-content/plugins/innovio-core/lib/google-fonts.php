<?php
if ( ! function_exists( 'innovio_mikado_init_google_fonts_array' ) ) {
    function innovio_mikado_init_google_fonts_array() {
        ...
        $innovio_mikado_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'innovio_mikado_init_google_fonts_array');
}