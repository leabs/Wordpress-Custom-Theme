...
class InnovioInstagramApi {
	...
	private $apiURL;
	/**
	 * @var InnovioInstagramApi instance of current class
	 */
	private static $instance;
	
	/**
	 * Helper object
	 * @var InnovioInstagramHelper
	 */
	private $helper;
	
	const CODE_OPTION_NAME = 'innovio_instagram_code';
	const USER_ID_OPTION_NAME = 'innovio_instagram_user_id';
	const ACCESS_TOKEN_OPTION_NAME = 'innovio_instagram_access_token';
	const CODE_REDIRECT_URI_OPTION_NAME = 'innovio_instagram_code_redirect_uri';
	 ...
	 * @return string
	 *
	 * @see InnovioInstagramApi::buildCurrentPageURI()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see InnovioInstagramApi::getAccessToken()
	 */
